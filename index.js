...
var client = mqtt.connect('mqtt://broker.emqx.io:1883',{clientId: 'deployment-mdcf0e98'});
...
var topic_list = ["temperature-humidity123"];
...
// var temp_graph = [];
// var date_graph = [];
client.subscribe("temperature-humidity123");
var m_time
var newTemp
var newHumi
var newLight
